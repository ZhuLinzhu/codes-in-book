...
def OLS(in_X_train,in_y_train,in_X_oos, in_oos_data):
    ...
    datalr = inner_oos_data[['Dates','permno','y','rethat']]
    datalr.columns = ['Dates','permno','y','yhat']
    datalr['model'] = 'ols'
...
def EN(in_X_train,in_y_train,in_X_test,in_y_test,in_X_oos, in_test_data, in_oos_data):
    ...
    for a in alphas:
        ...
        dataen = inner_oos_data[['Dates','permno','y','rethat']]
        dataen.columns = ['Dates','permno','y','yhat']
        dataen['model'] = 'EN' 
        dataen['AlphaValue'] = a 
...
def Ridge_method(in_X_train,in_y_train,in_X_test,in_y_test,in_X_oos, in_test_data, in_oos_data):
    ...
    for a in alphas:
        ...
        data_ridge = inner_oos_data[['Dates','permno','y','rethat']]
        data_ridge.columns = ['Dates','permno','y','yhat']
...
def Lasso_method(in_X_train,in_y_train,in_X_test,in_y_test,in_X_oos, in_test_data, in_oos_data):
    ...
    for a in alphas:
        ...
        data_lasso = inner_oos_data[['Dates','permno','y','rethat']]
        data_lasso.columns = ['Dates','permno','y','yhat']
...
def PCA_method(in_X_train,in_y_train,in_X_test,in_y_test,in_X_oos, in_test_data, in_oos_data):
    ...
    for i in range(5,11):  
        ...
        data_pca = inner_oos_data[['Dates','permno','y','rethat']]
        data_pca.columns = ['Dates','permno','y','yhat']
        data_pca['model'] = 'pca' 
        data_pca['n'] = i
...
def PLS_method(in_X_train,in_y_train,in_X_test,in_y_test,in_X_oos, in_test_data, in_oos_data):
    ...
    for k in range(1,9):  
        ...
        data_pls = inner_oos_data[['Dates','permno','y','rethat']]
        data_pls.columns = ['Dates','permno','y','yhat']
        data_pls['model'] = 'pls' 
        data_pls['n'] = k
...
def NN(in_X_train,in_y_train,in_X_test,in_y_test,in_X_oos, in_test_data, in_oos_data):
    ...
    for l in range(1,4):
        ...
        data_nn = inner_oos_data[['Dates','permno','y','rethat']]
        data_nn.columns = ['Dates','permno','y','yhat']
        data_nn['model'] = 'NN' 
        data_nn['layers'] = l
...
def RandomForest_method(in_X_train,in_y_train,in_X_test,in_y_test,in_X_oos, in_test_data, in_oos_data):
    ...
    for n in n_es:
        ...
        data_rf = inner_oos_data[['Dates','permno','y','rethat']]
        data_rf.columns = ['Dates','permno','y','yhat']
        data_rf['model'] = 'rf' 
...
def GBDT_method(in_X_train,in_y_train,in_X_test,in_y_test,in_X_oos, in_test_data, in_oos_data):
    ...
    for n in n_es:
        ...
        data_gbdt = inner_oos_data[['Dates','permno','y','rethat']]
        data_gbdt.columns = ['Dates','permno','y','yhat']
